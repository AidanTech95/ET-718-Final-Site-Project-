...
class SneakersControllerTest < ActionController::TestCase
  ...
  test "should create sneaker" do
    assert_difference('Sneaker.count') do
      post :create, sneaker: { brand: @sneaker.brand, description: @sneaker.description, price: @sneaker.price, size: @sneaker.size, string: @sneaker.string, text: @sneaker.text }
    end
  ...
  test "should update sneaker" do
    patch :update, id: @sneaker, sneaker: { brand: @sneaker.brand, description: @sneaker.description, price: @sneaker.price, size: @sneaker.size, string: @sneaker.string, text: @sneaker.text }
    assert_redirected_to sneaker_path(assigns(:sneaker))
  end
